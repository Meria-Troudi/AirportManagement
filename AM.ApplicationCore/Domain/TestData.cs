...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        // Staffs
        public static Staff captain = new Staff { FirstName = "captain", LastName = "captain", EmailAddress = "captain.captain@gmail.com",  EmploymentDate = new DateTime(1999, 01, 01), Salary = 99999 };
